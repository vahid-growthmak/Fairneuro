...
export const Brain = (p: IconProps) => (
  <Svg {...p}>
    <path d="M12 5.5a2.5 2.5 0 0 0-5 0 2.5 2.5 0 0 0-2 4 2.5 2.5 0 0 0 .5 4.5 2.5 2.5 0 0 0 3 3.5 2.5 2.5 0 0 0 3.5-.5Z" />
    <path d="M12 5.5a2.5 2.5 0 0 1 5 0 2.5 2.5 0 0 1 2 4 2.5 2.5 0 0 1-.5 4.5 2.5 2.5 0 0 1-3 3.5 2.5 2.5 0 0 1-3.5-.5Z" />
    <path d="M12 5.5V19" />
  </Svg>
);
...
export const TwoHeads = (p: IconProps) => (
  <Svg {...p}>
    <path d="M10 20v-2.2a4.2 4.2 0 0 0-1-2.6A5 5 0 0 1 10.6 7" />
    <circle cx="8.2" cy="10.4" r="0.9" />
    <path d="M14 20v-2.2a4.2 4.2 0 0 1 1-2.6A5 5 0 0 0 13.4 7" />
    <circle cx="15.8" cy="10.4" r="0.9" />
  </Svg>
);

export const Book = (p: IconProps) => (
  <Svg {...p}>
    <path d="M12 6.6C10.4 5.3 8.4 4.8 5.5 5.1a.7.7 0 0 0-.6.7v11a.7.7 0 0 0 .8.7c2.6-.3 4.5.1 6.3 1.4" />
    <path d="M12 6.6c1.6-1.3 3.6-1.8 6.5-1.5a.7.7 0 0 1 .6.7v11a.7.7 0 0 1-.8.7c-2.6-.3-4.5.1-6.3 1.4" />
    <path d="M12 6.6v12.3" />
  </Svg>
);
